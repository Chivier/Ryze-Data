"""Image-to-PDF conversion utilities for benchmark evaluation.

OCR models expect PDF input, but benchmark datasets provide images.
This module converts images to multi-page PDFs using Pillow.
"""
