...
HuggingFace inference with deepseek-ai/DeepSeek-OCR-2.
...
def load_model(gpu_id: int):
    """Load DeepSeek-OCR v2 model and tokenizer.
...
def main():
    ...
    logger.info("DeepSeek-OCR v2 — dataset=%s, gpu=%d, output=%s", args.dataset, args.gpu, output_dir)
