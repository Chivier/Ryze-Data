"""Unit tests for DeepSeek OCR v1 (mocked -- no GPU needed)."""
...
class TestRegistration:
    """Model must appear in the registry."""

    def test_deepseek_ocr_v1_registered(self):
        assert "deepseek-ocr" in OCRRegistry.list_all()

    def test_deepseek_ocr_v2_removed(self):
        assert "deepseek-ocr-v2" not in OCRRegistry.list_all()
